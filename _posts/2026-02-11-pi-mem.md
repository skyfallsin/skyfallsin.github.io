...
<p align="center" style="margin-bottom: 2em;">
  <img src="/images/posts/pi-mem.png" alt="pi-mem" width="350" />
</p>

I've been a bit obsessed with [@mariozechner's pi](https://github.com/mariozechner/pi-coding-agent) for a few weeks now ever since I noticed it was the Agent SDK behind openclaw. It's innately customizable and has many, many hooks to make it your own. Others have [compared it to vim](https://www.generativist.com/notes/2026/Feb/10/pi-is-vim) and I believe that's quite apt. 
