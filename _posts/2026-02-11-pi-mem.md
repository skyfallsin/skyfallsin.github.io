...
[@mariozechner's pi](https://pi.dev/) is the Agent SDK behind [OpenClaw](https://openclaw.ai). It's deeply customizable — hooks for every lifecycle event, extensions that modify the system prompt, tools that persist state. Others have [compared it to vim](https://www.generativist.com/notes/2026/Feb/10/pi-is-vim). That tracks.
